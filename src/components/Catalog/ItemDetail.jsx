...
export default function ItemDetail({ item }) {
    ...
    return (
        <section className="overflow-hidden h-auto">
            <div className="w-full px-8 py-4 flex flex-wrap">
                ...
                <div className="lg:w-1/2 w-full lg:pl-8 lg:py-2 mt-6 lg:mt-0">
                    ...
                    <div className="flex items-center border-b-2 border-stone-200">
                        <div className="py-4 flex items-center">
                            <span className="mr-4">Choose grip size:</span>
                    ...
                    {added === false ?
                        ...
                        (<Link to="/bag">
                            <button className="primaryBtn w-full">Go to bag</button>
                        </Link>
                        )
                    }
                </div>
            ...
            <section className="flex flex-col w-full px-8 py-4 flex-wrap gap-4">
                <h1 className="py-2 font-bold text-lg md:text-xl text-stone-900 uppercase">Specifications</h1>
                <ul className="flex flex-col gap-4 divide-y-2 divide-stone-200">
                    <li className="md:text-lg">Head: {item.head} sq in</li>
                    <li className="md:text-lg pt-4">Length: {item.length} in</li>
                    <li className="md:text-lg pt-4">String pattern: {item.stringPattern}</li>
                    <li className="md:text-lg pt-4">Strung weight: {item.strungWeight}g</li>
                    <li className="md:text-lg pt-4">Strung balance: {item.strungBalance}cm</li>
                </ul>
            </section>
            <ToastContainer
