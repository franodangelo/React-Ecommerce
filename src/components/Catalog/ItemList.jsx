    ...
    return (
        <>
            {items.length > 0 ?
                ...
                <div class="flex w-full h-[520px] justify-center place-items-center">
                    <div role="status">
                        <svg class="inline mr-2 w-20 h-20 text-gray-200 animate-spin dark:text-gray-400 fill-rose-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
